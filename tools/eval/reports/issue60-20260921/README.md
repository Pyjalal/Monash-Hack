...
The checked-out comparator, native reader, proof validator and exporter were used;
...
`freeze.json` binds the historical configuration and implementation hashes separately
from the checked-out component implementation, new fixture content and evaluator
implementation. This separation preserves the official run while making later
component changes explicit. `artifact-hashes.json` covers generated
