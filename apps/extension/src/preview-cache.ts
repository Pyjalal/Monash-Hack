...
function sanitizedResult(result: RowClassifyResult): RowClassifyResult | null {
  ...
  return {
    ...
    classification: {
      ...
      documentIssue: classification.documentIssue,
      documentIssueConfidence: classification.documentIssueConfidence,
      bodyDocument: classification.bodyDocument,
      bodyDocumentConfidence: classification.bodyDocumentConfidence,
